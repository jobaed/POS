<style>
    ...
    .dataTables_paginate>.pagination>.paginate_button .page-link i {
        color: #8d8c8b;
    }
</style>
...
<script>
    ...
    async function CustomerList() {
        ...
        customerTable.DataTable({
            ...
            language: {
                paginate: {
                    previous: '<i style="font-size: 33px;" class="bi bi-arrow-left-circle"></i>', // Use custom class for previous icon
                    next: '<i style="font-size: 33px;" class="bi bi-arrow-right-circle"></i>' // Use custom class for next icon
                }
            }
        });
    }
